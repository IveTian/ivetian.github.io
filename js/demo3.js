...
function(t) {
    function e(e) {
        for (var o, a, u = e[0], c = e[1], f = e[2], s = 0, p = []; s < u.length; s++) a = u[s],
        r[a] && p.push(r[a][0]),
        r[a] = 0;
    ...
    a.t = function(t, e) {
        ...
        if (a.r(n), Object.defineProperty(n, "default", {
            enumerable: !0,
            value: t
        }), 2 & e && "string" != typeof t) for (var o in t) a.d(n, o,
        function(e) {
            return t[e]
        }.bind(null, o));
        return n
    ...
    23 : function(t, e, n) {
        ...
        .15), Object(p.a)(r = o(r = function(t) {
            function e() {
                return v(this, e),
                w(this, g(e).apply(this, arguments))
            }
            return m(e, a["a"]),
            e
        } ()) || r) || r),
        M = new(function(t) {
            function e() {
                ...
                r = new Array(o), i = 0; i < o; i++) r[i] = arguments[i];
                return (n = w(this, (t = g(e)).call.apply(t, [this].concat(r)))).t = 0,
            ...
            d(e, [{
                ...
                value: function() {
                    this.t += .05,
                    this.position.y += .0025 * Math.sin(this.t)
                }
            }]),
            e
        } ())("Fighting!", {
        ...
        T = new(function(t) {
            ...
            {
                key: "addLine",
                value: function() { (y(g(e.prototype), "addLine", this).call(this, {
